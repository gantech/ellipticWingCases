...
maxTol = 1e-10;
try:
    d1, i1 = fast_io.load_ascii_output('/Users/gvijaya/CurrentProjects/HFM/FSI/11_2017/ellipticWing/ellipticWingCases/p1/deltaOverC_0p125_e0p5/EllipticWing.T1.out')
except:
...
#Actuator data
act_x, act_y, act_z, act_fx, act_fy, act_fz = np.loadtxt('/Users/gvijaya/CurrentProjects/HFM/FSI/11_2017/ellipticWing/ellipticWingCases/p1/deltaOverC_0p125_e0p5/actuator_forces.csv',delimiter=',',unpack=True)
act_x, act_y, act_z, act_vx, act_vy, act_vz = np.loadtxt('/Users/gvijaya/CurrentProjects/HFM/FSI/11_2017/ellipticWing/ellipticWingCases/p1/deltaOverC_0p125_e0p5/actuator_velocity.csv',delimiter=',',unpack=True)
